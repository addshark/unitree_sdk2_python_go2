...
| 35 | `dance1` | `Dance1()` | 舞蹈1 |
| 36 | `dance2` | `Dance2()` | 舞蹈2 |
| 37 | `heart` | `Heart()` | 比心动作 |
| 38 | `handshake` | `Hello()` | 握手动作 |
| 39 | `sit` | `Sit()` | 坐下动作 |
| 40 | `stretch` | `Stretch()` | 伸懒腰动作 |
...
echo -n "dance1" | nc -u -w1 192.168.2.11 8082
echo -n "dance2" | nc -u -w1 192.168.2.11 8082
echo -n "heart" | nc -u -w1 192.168.2.11 8082
echo -n "handshake" | nc -u -w1 192.168.2.11 8082
echo -n "sit" | nc -u -w1 192.168.2.11 8082
echo -n "stretch" | nc -u -w1 192.168.2.11 8082
