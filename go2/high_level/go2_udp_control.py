...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--goback-max-speed", type=float, default=0.4, help="Max forward/back speed for goback, default 0.40 m/s")
    parser.add_argument("--goback-max-lateral-speed", type=float, default=0.35, help="Max lateral speed for goback, default 0.35 m/s")
    ...
    parser.add_argument("--back-direction-max-yaw-speed", type=float, default=0.70, help="Max yaw speed for back_direction, default 0.70 rad/s")
