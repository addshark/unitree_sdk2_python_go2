...
option_list = [
    ...
    TestOption(name="move backward", id=20),
    TestOption(name="move left", id=4, aliases=("move lateral",)),
    TestOption(name="move right", id=21),
    TestOption(name="rotate left", id=5, aliases=("move rotate",)),
    TestOption(name="rotate right", id=22),
...
class UserInterface:
    ...
    def terminal_handle(self):
        ...
        for option in option_list:
            if input_str == option.name or input_str in option.aliases or self.convert_to_int(input_str) == option.id:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if test_option.id == 0:
            ...
            ret = sport_client.Move(0, LINEAR_SPEED, 0)
            print("ret: ",ret)
        elif test_option.id == 21:
            ret = sport_client.Move(0, -LINEAR_SPEED, 0)
            print("ret: ",ret)
        elif test_option.id == 5:
            ret = sport_client.Move(0, 0, YAW_SPEED)
            print("ret: ",ret)
